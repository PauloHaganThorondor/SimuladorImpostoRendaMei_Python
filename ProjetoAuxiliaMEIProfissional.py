...
def telaapresentacao():
    ...
    layout = [
        ...
        [sg.Frame(" Projeto da Turma A de Programação ", font=('Tahoma', 18), layout=[
            [sg.Canvas(background_color=None, size=(145, 10)), sg.Frame("", layout=[
                [sg.Image('CVTILogo.png')]], relief=sg.RELIEF_SUNKEN, border_width=5,pad=(10))],
            [sg.Text('''
...
def tela1(tema1):
    ...
    layout = [
        [sg.Frame(" Tela de Declaração de Renda ", font=('Helvetica', 14), layout=[
            [sg.Canvas(background_color=None, size=(115, 10)),sg.Frame("",layout=[
                [sg.Image('MEIReceitaLogo.png')] ], relief=sg.RELIEF_RAISED, border_width=4, pad=(10))],
            [sg.Canvas(background_color=None, size=(200, 10)),sg.Text('Digite a renda bruta para ser testado: R$',
                     font=('Helvetica', 16,'italic','bold')), sg.InputText(size=(10,45))],
            [sg.Frame("",layout=[
                [sg.Image('CVTILogo.png')] ], relief=sg.RELIEF_RAISED, border_width=4, pad=(10))],
...
def tela2(tema2, RendaBruta):
    ...
    layout = [
        [sg.Frame(" Tela de Declaração de Despesa ", font=('Helvetica', 14), layout=[
            [sg.Canvas(background_color=None, size=(115, 10)),sg.Frame("",layout=[
                [sg.Image('MEIReceitaLogo.png')] ], relief=sg.RELIEF_SUNKEN, border_width=5,pad=(10))],
            [sg.Canvas(background_color=None, size=(200, 10)),sg.Text('Digite o valor das despesas feitas pelo MEI: R$',
                     font=('Helvetica', 16,'italic','bold')), sg.InputText(size=(10,45))],
            [sg.Frame("",layout=[
                [sg.Image('CVTILogo.png')] ], relief=sg.RELIEF_SUNKEN, border_width=5,pad=(10))],
            [sg.Button('Prosseguir ➡', button_color=(
                '#1E90FF', '#363636'), pad=(15), border_width=4)]
        ], border_width=5)]
    ]
...
def tela3(RendaBruta, DespesaRenda):
    ...
    layout = [
        [sg.Frame(" Tela de Declaração de Ocupação do MEI ", font=('Helvetica', 14), layout=[
            [sg.Canvas(background_color=None, size=(140, 10)),sg.Frame("",layout=[
                [sg.Image('MEIReceitaLogo.png')] ], relief=sg.RELIEF_SUNKEN, border_width=5)],
            [sg.Canvas(background_color=None, size=(25, 10)),sg.Text('Indique qual é a sua ocupação para receber isenção: ', font=(
            ...
            [sg.Frame("",layout=[
                [sg.Image('CVTILogo.png')] ], relief=sg.RELIEF_SUNKEN, border_width=5)],
            [sg.Button('Prosseguir ➡', pad=(15), border_width=4)]
        ], border_width=5)]
    ]
